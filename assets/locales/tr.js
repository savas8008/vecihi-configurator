window.VECIHI_LOCALE_TR = {
  ...
  "blackbox": {
    ...
    "prof_title": "Döngü Profili (teşhis)",
    "prof_label": "Döngü profilini aç",
    "prof_note": "Turu 10 bölüme ayırıp saniyede bir ortalama/en kötü mikrosaniye yazar. USB takılıyken OSD kapalı olduğundan, OSD maliyetini görmek için açıp kabloyu çekin: rapor kayda \"Olaylar\" olarak düşer.",
    "prof_on": "Açık. Kabloyu çekip force arm ile 30 sn dönün, sonra logu okuyun — satırlar Olaylar sekmesinde.",
    "prof_on_short": "Açık.",
    "prof_off": "Kapalı.",
    "enable_label": "Uçuş kaydı açık",
    "enable_note": "Kapatırsanız uçuşta flash'a tek bayt bile yazılmaz. Ayar karta kaydedilir, güç kesilse de korunur.",
    "enable_on": "Uçuş kaydı açıldı. Ayar karta kaydedildi.",
    "enable_off": "Uçuş kaydı kapatıldı — uçuşta hiçbir şey yazılmayacak.",
    "status_device": "Cihazda {u} / {t} KB dolu.",
    "fast_title": "Filtre Kaydı (ayar için)",
    "fast_note": "Döngü hızında ham/notch/LPF üç aşamayı birden yazar. Kapasite ~2 dakika, bölen 4 ile ~8 dakika. Normal uçuşta KAPALI tutun.",
    "fast_off": "Kapalı",
    "fast_1": "Her tur (~2 dk)",
    "fast_2": "Her 2. tur (~4 dk)",
    "fast_4": "Her 4. tur (~8 dk)",
    "fast_apply": "Uygula",
    "fast_on": "Açık — her {n}. tur. Ayar karta kaydedildi, USB çekilince de korunur.",
    "fast_off_msg": "Kapalı. Ayar karta kaydedildi.",
    "fast_was_on": "Bu kayıtta açıktı — her {n}. tur.",
    "fast_was_off": "Bu kayıtta kapalıydı.",
    "erase_done": "Silindi. Cihazda {n} KB kayıt kaldı.",
    "summary_title": "Özet",
    "health_title": "Sağlık",
