window.VECIHI_LOCALE_EN = {
  ...
  "blackbox": {
    "page_title": "Flight Log (Blackbox)",
    "btn_read": "Read Log",
    "btn_erase": "Erase Log On Device",
    "status_ready": "Ready. Use \"Read Log\" to pull the recording from the device.",
    "status_sent": "Command sent, waiting for device response...",
    "status_reading": "Reading...",
    "status_done": "Ready",
    "erase_note": "Erasing takes a few seconds and must be done on the ground. No flash erase ever happens in flight — that is the design that prevents lockups.",
    "erase_confirm": "ALL flight logs on the device will be erased. Are you sure?\n\nNote: erasing takes a few seconds and must be done ON THE GROUND.",
    "erase_sent": "Erase command sent (may take a few seconds)",
    "not_read": "No log read yet.",
    "prof_title": "Loop Profile (diagnostic)",
    "prof_label": "Enable loop profile",
    "prof_note": "Splits each loop into 10 sections and writes average/worst microseconds once per second. USB keeps the OSD off, so to see the OSD cost enable this and unplug: the report lands in the log as \"Events\".",
    "prof_on": "On. Unplug, force arm and run for 30 s, then read the log — the lines are in the Events tab.",
    "prof_on_short": "On.",
    "prof_off": "Off.",
    "enable_label": "Flight logging on",
    "enable_note": "If you turn this off, not a single byte is written to flash in flight. The setting is saved to the board and survives a power cut.",
    "enable_on": "Flight logging enabled. Setting saved to the board.",
    "enable_off": "Flight logging disabled — nothing will be recorded in flight.",
    "status_device": "{u} / {t} KB used on the device.",
    "fast_title": "Filter Log (for tuning)",
    "fast_note": "Writes raw/notch/LPF stages at loop rate. Capacity ~2 minutes, ~8 minutes with divider 4. Keep it OFF for normal flights.",
    "fast_off": "Off",
    "fast_1": "Every loop (~2 min)",
    "fast_2": "Every 2nd loop (~4 min)",
    "fast_4": "Every 4th loop (~8 min)",
    "fast_apply": "Apply",
    "fast_on": "On — every {n}. loop. Saved to the board; it survives unplugging USB.",
    "fast_off_msg": "Off. Saved to the board.",
    "fast_was_on": "It was on for this log — every {n}. loop.",
    "fast_was_off": "It was off for this log.",
    "erase_done": "Erased. {n} KB of log left on the device.",
    "summary_title": "Summary",
    "health_title": "Health",
    "health_clean": "The log looks clean.",
    "download_title": "Download",
    "dl_flight": "Flight log (CSV)",
    "dl_filter": "Filter log (CSV) — for tuning",
    "dl_events": "Events (CSV)",
    "dl_raw": "Raw data (.bin)",
    "tab_charts": "Charts",
    "tab_flight": "Flight (10 Hz)",
    "tab_filter": "Filter (full rate)",
    "tab_events": "Events",
    "chart_att": "Attitude — roll / pitch (degrees)",
    "chart_alt": "Altitude (m) and ground speed (m/s)",
    "chart_gyro": "Gyro — the value the PID sees (deg/s)",
    "chart_dt": "Loop period min / avg / max (µs) — the RPM notch filter breaks under excessive jitter",
    "chart_err": "Error counters (increase per interval)",
    "chart_filter": "Filter chain — roll axis: raw / after notch / after LPF. Compare these three for tuning.",
    "filter_hint": "This log contains all three stages of the filter chain: raw → after notch → after LPF. Download the CSV to tune the filters.",
    "sum_raw": "Raw data",
    "sum_sessions": "Sessions",
    "sum_slow": "Flight records (10 Hz)",
    "sum_fast": "Filter records (full rate)",
    "sum_events": "Events",
    "sum_duration": "Recording length",
    "unit_bytes": "bytes",
    "unit_min": "minutes",
    "no_records": "No records of this type.",
    "no_events": "No event records.",
    "table_limit": "Showing first {n} rows (of {total}). Download the CSV for all of them.",
    "warn_drop": "{n} records were dropped because the RAM buffer was full — there are gaps in the log.",
    "warn_notch": "The notch filter produced {n} corrupted samples — the loop period is jittering excessively. Filter tuning is unreliable for this flight.",
    "warn_spike": "{n} gyro spikes rejected.",
    "warn_clip": "{n} accelerometer clipping events (vibration/impact).",
    "warn_jitter": "Loop period {min}-{max} µs (±{pct}% jitter). Above 30% can break the notch filter.",
    "warn_bad": "{n} undecodable bytes — the recording may have been cut off abruptly (crash/power loss).",
    "log_downloading": "Downloading blackbox: {n} bytes",
    "log_decoded": "Blackbox decoded: {slow} flight records, {fast} filter records, {ev} events",
    "log_saved": "Downloaded: {name}",
    "ds_roll": "roll",
    "ds_pitch": "pitch",
    "ds_alt": "altitude (m)",
    "ds_gspd": "ground speed (m/s)",
    "ds_gx": "gyro X",
    "ds_gy": "gyro Y",
    "ds_gz": "gyro Z",
    "ds_min": "min",
    "ds_avg": "avg",
    "ds_max": "max",
    "ds_notch": "notch reject",
    "ds_spike": "gyro spike",
    "ds_clip": "accel clip",
    "ds_drop": "dropped record",
    "ds_raw": "raw",
