...
function updateConnectionStatus() {
    ...
    // Firmware Güncelle butonu: bağlantı yokken görünür, bağlıyken gizli
    const btnFirmware = el('btnFirmware');
    if (btnFirmware) btnFirmware.classList.toggle('d-none', connected);
    ...
    // Navigasyon menüsü: Tüm sekmeler her zaman görünür ve erişilebilir
