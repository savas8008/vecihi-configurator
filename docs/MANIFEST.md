...
Pazardaki köklü yazılımların temelleri eski işlemcilere dayandığı için, günümüzün modern çok çekirdekli mikrodenetleyicilerine geçildiğinde bile yazılım mimarisi tek bir iş parçacığı (thread) üzerinden yürümeye devam etmektedir. Vecihi ise ESP32'nin **çift çekirdekli (Dual-Core)** yapısına özgü (native) olarak sıfırdan tasarlanmıştır.
